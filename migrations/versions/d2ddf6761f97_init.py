...
Revision ID: d2ddf6761f97
Revises: 
Create Date: 2024-04-28 11:28:11.317245
...
def upgrade() -> None:
    ...
    sa.Column('nik', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    ...
    sa.UniqueConstraint('nik', postgresql_nulls_not_distinct=True),
